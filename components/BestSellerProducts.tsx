...
export default function BestSellerProducts({ products }: { products: BestSellerProduct[] }) {
  return <section className="bg-[#fafafa] px-6 py-14 max-md:px-4 max-md:py-10" aria-labelledby="bestsellers-title">
    <div className="mx-auto max-w-7xl">
      ...
      {products.length === 0 && <p className="border border-[#d5dadd] p-10 text-center text-sm text-gray-500">No bestselling products are available right now.</p>}
    </div>
  </section>;
}
